...
export TERRAFORM_STATE_CONTAINER_NAME="tfstatepredmgmt"
...
export TF_VAR_ocp_vers="4.10.16"

# Set if a WAF Access allow list is required
export TF_VAR_waf_access_list_enabled=false
...
export INFRA_SUB='UKSC-DD-ASDT_PREDA-INFRA_PROD_001' # Infrastructure Subscription name
echo "setting Mgmt account"
...
export kv_name="kv-prod-shared-aa-uks"
