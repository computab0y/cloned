...
export OCP_INSTANCE="ocp5"
export TERRAFORM_STATE_CONTAINER_NAME="tfstatepredmgmt5"
...
export TF_VAR_op_env="dev"  #e.g. prod, preprod, test...

# Version of the OCP instance to install
export TF_VAR_ocp_vers="4.9.31"
...
#Resource Group Tags
export TF_VAR_solution="OCP Dev"
...
export VNET_IP_ADDR_SPACE="10.5.0.0/16"

export PUB_DNS_SUB='UKSC-DD-ASDT_PREDA-MGMT_PROD_001' # Management Subscription name (SO1 PROD Sub hosts the Public DNS Zone)
export MGMT_SUB='UKSC-DD-ASDT_PREDA-MGMT_DEV_001 '   # Management Subscription name
export INFRA_SUB='UKSC-DD-ASDT_PREDA-INFRA_DEV_001'  # Infrastructure Subscription name

az account set --subscription $MGMT_SUB

export TF_VAR_spn_obj_name="UKSC-DD-ASDT_PREDA-INFRA_DEV_001_165d_app_RHOCP0" # Name of the Azure AD SPN used for automation
