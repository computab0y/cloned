...
#Rule to allow IP address list specified in Variable var.app_gw_allow_ips.
  ...
  managed_rules {
      # these are currently global as TF has no way to apply to individual OWASP3.2 rules yet. revisit when able.  https://github.com/hashicorp/terraform-provider-azurerm/issues/16934
      /* exclusion {
