...
export OCP_INSTANCE="ocp4"
export TERRAFORM_STATE_CONTAINER_NAME="tfstatepredmgmt4"
...
export TF_VAR_waf_public_domains_enabled=false

#Operating Environment for the cluster
export TF_VAR_op_env="sbox"  #e.g. prod, preprod, sbox, test...
...
export INFRA_SUB='UKSC-DD-ASDT_PREDA-INFRA_SBOX_002' # Infrastructure Subscription name+
export IMAGES_SUB='JFC-ISS-ASDT_Azure-Publishing_deviacemodgovuk_Dev' # Golden Images subscription - Dev
...
# export TF_VAR_spn_obj_name="UKSC-DD-ASDT_PREDA-INFRA_SBOX_002_7d04_app_OCIPI0010" # Name of the Azure AD SPN used for automation
...
export kv_name="kv-sbox-infra-bf04-uks"

export lb_internal_ip="10.68.58.9"